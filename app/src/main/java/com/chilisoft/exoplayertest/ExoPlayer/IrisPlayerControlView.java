 ...
 *         <li>Default: {@link IrisPlayerControlView#DEFAULT_REPEAT_TOGGLE_MODES}
 *       </ul>
 ...
 */
public class IrisPlayerControlView extends FrameLayout {
  ...
  public IrisPlayerControlView(Context context) {
    this(context, /* attrs= */ null);
  }

  public IrisPlayerControlView(Context context, @Nullable AttributeSet attrs) {
    this(context, attrs, 0);
  }

  public IrisPlayerControlView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    this(context, attrs, defStyleAttr, attrs);
  }

  public IrisPlayerControlView(
      Context context,
  ...
  private final class ComponentListener
    ...
    public void onClick(View view) {
      Player player = IrisPlayerControlView.this.player;
      if (player == null) {
        return;
      }
      if (nextButton == view) {
