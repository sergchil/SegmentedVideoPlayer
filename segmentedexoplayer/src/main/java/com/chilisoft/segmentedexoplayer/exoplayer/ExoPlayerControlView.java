 ...
 */
package com.chilisoft.segmentedexoplayer.exoplayer;
...
public class ExoPlayerControlView extends FrameLayout {
    ...
    public ExoPlayerControlView(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ExoPlayerControlView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    private final class ComponentListener
        ...
        public void onClick(View view) {
            Player player = ExoPlayerControlView.this.player;
            if (player == null) {
                return;
            }
            if (nextButton == view) {
