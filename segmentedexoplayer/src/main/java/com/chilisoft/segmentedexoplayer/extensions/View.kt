...
fun View.setPaddingStart(paddingStart: Int) = ViewCompat.setPaddingRelative(
    this,
    paddingStart,
    paddingTop,
...
fun View.setPaddingTop(paddingTop: Int) = ViewCompat.setPaddingRelative(
    this,
...
fun View.setPaddingEnd(paddingEnd: Int) = ViewCompat.setPaddingRelative(
    this,
    ViewCompat.getPaddingStart(this),
    paddingTop,
    paddingEnd,
...
fun View.setPaddingBottom(paddingBottom: Int) = ViewCompat.setPaddingRelative(
    this,
    ViewCompat.getPaddingStart(this),
    paddingTop,
    ViewCompat.getPaddingEnd(this),
