 ...
 */
public class IrisPlayerView extends FrameLayout implements AdsLoader.AdViewProvider {
  ...
  @Nullable public final IrisPlayerControlView controller;
  ...
  public IrisPlayerView(Context context) {
    this(context, null);
  }

  public IrisPlayerView(Context context, AttributeSet attrs) {
    this(context, attrs, 0);
  }

  public IrisPlayerView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    IrisPlayerControlView customController = findViewById(R.id.exo_controller);
    ...
    if (customController != null) {
      ...
      this.controller = new IrisPlayerControlView(context, null, 0, attrs);
  ...
  public static void switchTargetView(
          Player player, @Nullable IrisPlayerView oldPlayerView, @Nullable IrisPlayerView newPlayerView) {
   ...
   * {@link #switchTargetView(Player, IrisPlayerView, IrisPlayerView)} rather than this method. If you do
   ...
   */
  public void setControllerVisibilityListener(IrisPlayerControlView.VisibilityListener listener) {
    Assertions.checkState(controller != null);
